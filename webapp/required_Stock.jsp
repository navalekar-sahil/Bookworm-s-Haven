...
<body>
	<%
	ArrayList<BookShopPojo> list = (ArrayList<BookShopPojo>) request.getAttribute("list1");
	%>
	<div class="row">
		<div class="col-2">
	...
	<div class=" card shadow-lg p-3 mb-5 bg-white rounded"
		style="margin-right: 30px; margin-top: 50px; margin-bottom: 30px; margin-left: 30px">
		<h2>All Books</h2>
